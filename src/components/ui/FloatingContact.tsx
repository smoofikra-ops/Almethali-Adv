  ...
  return (
    <div className={`fixed bottom-6 left-6 z-50 flex flex-col gap-3 md:bottom-10 md:left-10`}>
      ...
      <a 
        ...
        className="group relative flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-accent text-white rounded-full shadow-lg shadow-accent/20 transition-transform hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        aria-label="WhatsApp"
      >
        <MessageCircle className="w-6 h-6 md:w-7 md:h-7" />
        
        {/* Tooltip */}
        <div className={`absolute top-1/2 -translate-y-1/2 start-full ms-3 px-3 py-1.5 bg-accent text-white text-sm font-bold rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity whitespace-nowrap`}>
