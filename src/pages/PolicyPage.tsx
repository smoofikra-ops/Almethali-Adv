...
const policiesContent: Record<string, { title: string, content: string }> = {
  usage: {
    ...
    content: `
      مرحباً بكم في ${contactConfig.tradeNameAr}. باستخدامك لمنصتنا وخدماتنا، فإنك تقر وتوافق على الالتزام بسياسة الاستخدام المقبولة.

      1. الاستخدام المشروع:
      يجب استخدام الموقع والخدمات للأغراض المشروعة فقط ووفقاً للأنظمة واللوائح المعمول بها في المملكة العربية السعودية.

      2. حماية الملكية الفكرية:
      جميع المحتويات، الشعارات، الصور، والتصاميم المنشورة على هذا الموقع هي ملك حصري لـ ${contactConfig.tradeNameAr} ومحمية بموجب أنظمة حماية حقوق المؤلف والعلامات التجارية.

      3. سلامة الموقع:
      يحظر محاولة تعطيل، اختراق، أو إرسال طلبات آلية غير مصرح بها إلى الموقع أو استغلال أي ثغرة أمنية.

      لأية استفسارات أو ملاحظات بخصوص سياسة الاستخدام، يرجى التواصل معنا عبر ${contactConfig.email}.
    `
  },
  privacy: {
